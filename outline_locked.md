...
- ~~**Ch3/4/5 解禁**~~：✅ 已解禁（`98b7371`，2026-04-11）
- **repo 轉 public**：解禁已完成，可執行
- ~~**cinder-capture repo 轉回 public**~~：✅ User 已轉（PoC 測試時同步處理）
...
**全書完成，全章解禁**。序章＋Ch1–5＋後記＋附錄全部公開上線（2026-04-11 解禁）。每章均經北極星三規則驗稿（iter 3 之後固定紀律），中文定稿→翻英文→英文驗稿→中英對齊。
