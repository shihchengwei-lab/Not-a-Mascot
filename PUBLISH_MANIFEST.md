...
| — | Ch3 | `draft_ch3.md` | `draft_ch3_en.md` | ✅ iter 6 寫完驗過，embargo — 等 Anthropic 修好 Ch4 的路 |
| — | Ch5 | `draft_ch5.md` | `draft_ch5_en.md` | ✅ **iter 7 寫完驗過**，embargo — 跟 Ch3/Ch4 一起解禁 |
| 4 | Ch4 | 未開工 | 未開工 | ⏳ embargo，紅線最硬的一章 |
...
| 角色 | 狀態 |
|---|---|
| Ch3 / Ch4 / Ch5 | embargo，未開工。動筆前必讀 `handoff_2026-04-10_early.md` 的 embargo 警告段落 |
...
- [ ] 決定 Phase 2 embargo 章節的出版時機（Anthropic 修好後）
...
- **Embargo 鄰近區域警告**：iter 1 handoff 內 embargo 警告已讀；Ch1 寫作時 User 校準過 1.4 的 Cinder bubble 詮釋邊界
